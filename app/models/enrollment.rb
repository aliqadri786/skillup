class Enrollment < ApplicationRecord
  ...
  validates_uniqueness_of :user_id, scope: :course_id # user can not subscribe same course twice
  validates_uniqueness_of :course_id, scope: :user_id # user can not be subscribed same course twice
